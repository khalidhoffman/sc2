...
gulp.task('auto', function(){
    ...
    gulp.watch(utils.buildGlobSelector(project.tasks['js-src'], '{**,!node_modules,!vendors}/**/*.{js,jsx}'), ['build-webpack']);
...
gulp.task('build-requirejs', lib('javascript').buildRequireJS);
